"""
Промежуточное ПО (middleware) для обеспечения HTTPS-соединений
и установки заголовков безопасности.

Разработано в рамках сопровождения BMC_analyzer согласно ГОСТ 12207
(управление модификацией).

Версия: 2.0.0 (переход HTTP → HTTPS)
Дата: 2026-05-03
"""
